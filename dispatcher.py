...
{{
  ...
  "exec_decision": "경영층 판단 필요 사안 — 'N건 — 회사명: [액션키워드] 사유' 형식으로 작성. 액션 키워드 선택 기준: [손상인식] 자본잠식·대규모 손실·IPO 무기한 연기 등 재무 훼손 확인 시, [Exit 검토] 경영권 분쟁·핵심 인력 이탈·사업 축소 등 Exit 타이밍 검토 필요 시, [추가투자] 성장 가속·경쟁 우위 확보 등 기회 포착 시에만 사용, [홀드] 관망이 최선이나 임박한 변수 존재 시, [관계정리] 협업 중단·계약 종료 검토 필요 시. 없으면 '없음 — 정기 모니터링 유지'"
}}
